...
<%
	...
	//sess.getAttribute("password");//this will return password Any time in the session
	 try {
         list = DBUtils.queryProcess2(controlNumber,sort);
		...
		reportName="CONTROL NUMBER SEARCH";
...
<table>
<tr>
<TD colspan=7 style="text-align:center"><font size="5" face=verdana><B><%=reportName%></B></font></TD>
</tr>
<tr>
...
<tr><th>Overdue</th><th>Control Number</th><th>Name</th><th>Model</th><th>Serial Number</th><th>PM Freq</th><th>Facility/Department</th></tr>
<%
...
//{
 ...
 <td><%=repDetails.facility%>,<%=repDetails.deptName%></td>
